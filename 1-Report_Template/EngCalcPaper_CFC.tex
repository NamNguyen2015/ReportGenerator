...
\usepackage{graphicx} % Required to show graphics
...
\put(170, 264){\includegraphics[height=23mm,keepaspectratio]{../../1-Report_Template/Images/CFC.jpeg}} % Logo box - maximum height/width:
}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{../../2-Calculation_Output/Temporal_Images/-VARfig1-}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{../../2-Calculation_Output/Temporal_Images/-VARfig2-}
    \caption{This figure can be changed}
\end{figure}
...
% \includegraphics{../2-Calculation_Output/fi_s001-GEOM.ps}
%----------------------------------------------------------------------------------------
